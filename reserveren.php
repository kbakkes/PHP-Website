...
<head>
    ...
    <title>Reserveringsite | Reserveren</title>

    <!--de volgende 4 regels zijn voor de datepicker -->
...
<div class="socialmedia">
    <a href="https://www.facebook.com/bernas.hairenbeautysalon?fref=ts" target="_blank"><img id="facebook" src="img/facebook.png"></a>
    <a href="https://www.instagram.com/bernashairbeauty/" target="_blank"><img id="insta" src="img/instagram.png"></a>
</div>
    ...
    <div class="introtext">
     ...
     '%s','%s','%s','%s','%s','%s'
            ...
            <div class="form">
                <h2>Reserveren</h2>
                <br>
            <form class="lijst" method="post" action="">
                Naam:<br>
             ...
             Behandeling: </br>
                <select name="behandeling">
                    ...
                    <option value="Wassen knippen föhnen kort haar ">Wassen knippen fohnen kort haar</option>
                    <option value="Wassen knippen föhnen halflang haar ">Wassen knippen fohnen halflang haar</option>
                    <option value="Wassen knippen fohnen lang haar ">Wassen knippen fohnen lang haar</option>
                    <option value="Wassen knippen föhnen lang haar ">Wassen knippen fohnen lang haar</option>
